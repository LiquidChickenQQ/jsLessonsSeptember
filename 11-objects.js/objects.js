...
// console.log(netflix.season1.seasonInfo.episodeInfo[8].episodeName, netflix.season1.seasonInfo.episodeInfo[8].episode);
...
//console.log(spaceJam.nbaPlayers.phoenixSuns); // Charles Barkley
...
// console.log(garden.value, garden['vegitable']);
